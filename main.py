"""
Raro é o escasso que independente da situação se destaca. ~ hake rare mindset
"""
...
try: 
    ...
    for token in tokens: tokens_index[token] = {'is_sleeping': False, 'is_rate_limit': False, 'reply_users_sience' : {}}
                        ...
                        if "guild_id" in user:
                            if not nav.check_user(user['id']):
                                if nav.add_user(user['id']):
                                    tokens_index[token]['is_sleeping'] = True
                                    try:
                                    ...
                                    try:
                                     ...
                                     guild = None
                                    print(f'{colors.GREY}[{colors.BLUE}>{colors.GREY}]{colors.RESET} {get_id(bot._Client__user_token)} {colors.GREY}|{colors.BLUE} Capturado{colors.RESET}: {colors.CYELLOW}{user["username"]}{colors.RESET}. {colors.BLUE}Servidor{colors.RESET}: {colors.CYELLOW}{guild}')
...
{colors.RED}by discord.gg/impulso{colors.BLUE}                    
{colors.RESET}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
{colors.BLUE} Tempo de espera{colors.RESET}: {settings["dm_cooldown"]} segundos
{colors.BLUE} Total de tokens{colors.RESET}: {len(tokens)}
{colors.RESET}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━'''
 return start_banner
...
def update_title(guilds=None):
    os.system(f'title [Impulso] Selfbot [Enviados {stats.dms_deliver}, Capturados {stats.dms_captured}, Multi-tokens {len(tokens)}, Servidores {guilds}]')
        ...
        def AfterReadySupp(resp, bot):
            if resp.event.ready_supplemental:
                        ...
                        try:
                         ...
                         bot.gateway.setCustomStatus("By Impulso")
                        except:
                            pass
        clients = []
